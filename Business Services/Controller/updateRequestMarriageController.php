<?php
include_once 'C:\xampp\htdocs\E-munakahat\Business Services\Model\requestMarriageModel.php';

function getRequestMarriageDetails($applicantIc) {
    global $con; // Add this line to access the $con variable
...
function updateRequestMarriage($applicantIc, $applicantName, $partnerIc, $partnerName) {
    global $con; // Add this line to access the $con variable
